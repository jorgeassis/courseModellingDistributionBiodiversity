...
presences <- read.table('myRecords.csv',sep=';',header=TRUE)
...
environmentalLayers <- download_multiple_layers(variables=variables, experiment=c"baseline", decade=2010 , longitude = c(-12,33) , latitude = c(32,46))
